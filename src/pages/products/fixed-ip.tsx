            ...
            <div role="group" aria-roledescription="slide" className="min-w-0 shrink-0 grow-0 basis-full z-50">
              <div className="banner-content relative min-h-[inherit] h-[120vw] md:h-[23vh] lg:h-[22rem] xl:h-[67vh] 2xl:h-[50.8vh]">
                <img 
                  ...
                  decoding="async" 
                  data-nimg="fill" 
                  className="max-w-full h-auto object-cover md:object-center object-center absolute hidden md:block" 
                ...
                <img 
                  ...
                  decoding="async" 
                  data-nimg="fill" 
                  className="max-w-full h-auto object-cover md:object-center object-center absolute block md:hidden" 
                  style={{ position: "absolute", height: "100%", width: "100%", left: 0, top: 0, right: 0, bottom: 0, color: "transparent" }} 
                  sizes="50vh" 
                ...
                <div className="relative h-full min-h-[inherit] select-none pointer-events-none">
                  <div className="pointer-events-auto h-full">
                    <div className="h-full w-full">
                      <div className="flex flex-col md:flex-row h-full w-full min-h-[inherit] md:justify-start justify-start">
                        <div className="h-full w-full">
            ...
            <div role="group" aria-roledescription="slide" className="min-w-0 shrink-0 grow-0 basis-full z-50">
              <div className="banner-content relative min-h-[inherit] h-[120vw] md:h-[23vh] lg:h-[22rem] xl:h-[67vh] 2xl:h-[50.8vh]">
                <img 
                  ...
                  decoding="async" 
                  data-nimg="fill" 
                  className="max-w-full h-auto object-contain md:object-center object-center absolute hidden md:block" 
                  style={{ position: "absolute", height: "100%", width: "100%", left: 0, top: 0, right: 0, bottom: 0, color: "transparent" }} 
                  sizes="100vw" 
                ...
                <img 
                  ...
                  decoding="async" 
                  data-nimg="fill" 
                  className="max-w-full h-auto object-contain md:object-center object-center absolute block md:hidden" 
                  style={{ position: "absolute", height: "100%", width: "100%", left: 0, top: 0, right: 0, bottom: 0, color: "transparent" }} 
                  sizes="50vh" 
